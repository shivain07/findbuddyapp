  ...
  return (
    <div className="w-full h-full">
      <div className="grid grid-cols-12 gap-2">
        ...
        <div className="col-span-12 sm:col-span-6 lg:col-span-3 m-2 rounded-lg min-h-60 p-2 pt-4 order-1 lg:order-1">
          <Sidebar />
        </div>
        ...
        <div className="col-span-12 sm:col-span-6 lg:col-span-3 m-2 mt-2 pt-6 order-2 lg:order-3">
          <ProfileCard />
        </div>
      </div>
    </div>
